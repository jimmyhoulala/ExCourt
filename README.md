# 易场地 - 同济大学体育馆场地交换系统 / ExCourt - Tongji University Sports Venue Exchange System
...
7. **账户管理 / Account Management**  
   ...
   - Supports personal information and reputation management to ensure smooth transactions.
...
- `/ExCourt_front`: 前端代码（微信小程序）/ Frontend code (WeChat Mini Program)
- `/SchoolAPI`: 后端代码与API接口（模拟学校数据库）/ Backend code and API interfaces simulating the school database
